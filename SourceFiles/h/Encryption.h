...
#define Nk 4					// Key length in bytes [128 bit]
...
extern ENCRYPT Encryption[MAX_NO_OF_LOCOS];
...
extern unsigned short RS;

unsigned short int ComputeMAC_Code(unsigned char *pcMsg,unsigned char ucStartByte,
							unsigned char ucEndByte, unsigned short RL,unsigned long ulLocoID) ;
